...
$TPrGr = array(  // Географическая широта, географическая долгота, коэффициент притяжения k=ni/N
  array(51.53878192549949, 51.53878192549949, 0.2, 'СГУ'),
...
<script>
<?php echo "map.addLayer(new L.marker([51.5177820731346,46.006962588980315],{draggable: 'true'}));";?>
<?php for ($i=1; $i < count($TPrGr); $i++) { 
